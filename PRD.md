# TeamFlow PRD (Product Requirements Document)
...
### 한 줄 정의
> *"모든 팀원의 데일리 스크럼이 전사 목표와 얼마나 연결돼 있는지를 실시간으로 시각화하고, AI가 의사결정을 도와주는 팀 생산성 플랫폼"*
...
TeamFlow는 이 문제를 **이니셔티브 → 목표 → 오늘 할일** 3계층 구조 + AI 자동 매핑으로 해결한다.
